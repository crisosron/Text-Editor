...
public class Drawer {
     ...
     */
    public void drawNewLine(int startX, int startY, int endX, int endY, Color selectedColor){
     ...
     */
    public void drawNewRectangle(int startX, int startY, int endX, int endY, Color selectedColor){
        graphics2D.setColor(selectedColor);
        int x = startX;
        int y = startY;
     ...
     */
    public void drawNewOval(int startX, int startY, int endX, int endY, Color selectedColor){
        graphics2D.setColor(selectedColor);
        int x = startX;
        int y = startY;
        int width = endX - startX;
